...
| 破折号 | 几乎不用，用逗号/句号/冒号 | 大量「——」表示停顿/转折/解释 |
| 引号 | 用半角双引号 `""` | 高频使用角引号「」 |
